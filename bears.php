...
<body>
    ...
    <div class="container">
        <div class="rate_main">
            <h1 class="lr">Медведи</h1>
            <img src="images/bear.svg" class="team_icon">
    ...
    <div class="container">
        <table style="width:100%; padding-bottom: 20px" class="rating_output">
            ...
            $query = mysqli_query($mysqli, "SELECT Имя, Фамилия, Инд_рейтинг FROM курсанты WHERE id_группы = 3");
    ...
    $query = mysqli_query($mysqli, "SELECT * FROM груп_рейтинг WHERE id_группы = 3");

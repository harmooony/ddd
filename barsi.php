...
<body>
    ...
    <div class="container">
        <table style="width:100%; padding-bottom: 20px" class="rating_output">
            <tr>
                <th style="width:50%;" class="rate_name">Имя</th>
                <th style="width:50%;" class="rate_num">Рейтинг</th>
            </tr>
            ...
            $query = mysqli_query($mysqli, "SELECT Имя, Фамилия, Инд_рейтинг FROM курсанты WHERE id_группы = 2");
